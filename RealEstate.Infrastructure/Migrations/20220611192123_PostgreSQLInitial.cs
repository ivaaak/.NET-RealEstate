        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateListed = table.Column<DateTime>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateListed = table.Column<DateTime>(type: "date", nullable: false),
                    Currency = table.Column<int>(type: "integer", maxLength: 500, nullable: false),
                    Price = table.Column<int>(type: "integer", nullable: false),
                    PropertyId1 = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Listing_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Listing_Properties_PropertyId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listing_DealId",
                table: "Listing",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_Listing_PropertyId1",
                table: "Listing",
                column: "PropertyId1");
