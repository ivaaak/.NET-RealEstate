...
namespace EstatesMicroservice.Properties
{
    public static class HostExtensions
    {
        ...
        private static void ExecuteMigrations(IConfiguration configuration)
        {
            ...
            command.CommandText = "DROP TABLE IF EXISTS Estates";
            command.ExecuteNonQuery();

            command.CommandText = @"CREATE TABLE Estates";
            command.ExecuteNonQuery();


            command.CommandText = "INSERT INTO Estates(Name, Description) VALUES('Name', 'Description');";
            command.ExecuteNonQuery();
            command.CommandText = "INSERT INTO Estates(Name, Description) VALUES('Name', 'Description');";
            command.ExecuteNonQuery();
        }
